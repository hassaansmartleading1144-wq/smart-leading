...
<div class="about-page">
	...
	sln_render_page_banner(
		array(
			'title'            => __( 'About Us', 'smart-leading-net' ),
	...
	<section class="about-overview section-padding" aria-labelledby="about-overview-heading">
		<div class="about-overview__container sls-container">
			<div class="about-overview__grid">
				<div class="about-overview__content">
					...
					<h2 id="about-overview-heading" class="about-overview__title">
